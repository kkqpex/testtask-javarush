...
<head>
    ...
    <meta id="root" about="${contextPath}">
    <link href="${contextPath}/resources/bootstrap-4.3.1-dist/css/bootstrap.css" rel="stylesheet">
    <link href="${contextPath}/resources/bootstrap-4.3.1-dist/js/jq.js" rel="stylesheet">
    <script type="text/javascript" src="${contextPath}/resources/bootstrap-4.3.1-dist/js/jq.js">
    </script>
    <script type="text/javascript" src="${contextPath}/resources/bootstrap-4.3.1-dist/js/bootstrap.js">
    </script>
    <script type="text/javascript" src="${contextPath}/resources/scripts.js">
    </script>

</head>
<body onload="loadContent('${contextPath}','', 1);">
<div class="container">
    ...
    <h1 style="text-align: center; margin-top: 50px; margin-bottom: 30px">Spaceship rating</h1>
        ...
        <select style="float: left" onchange="processSearch('${contextPath}', 1)" style="margin-left: 5px" id="order"
        ...
        <select style="float: right" onchange="processSearch('${contextPath}', 1)" style="margin-left: 5px" id="limit"
                class="form-control-sm">
            <option>1</option>
...
<br>
    ...
    <form style="background-color: #E9ECEF; padding: 20px; border-radius: 10px; display: none" id="createButton">
        ...
        <button type="button" onclick="processCreate('${contextPath}')" class="btn btn-success">
            Create
        </button>
    </form>
    ...
    <form style="background-color: #E9ECEF; padding: 20px; border-radius: 10px">
        ...
        <button type="button" onclick="processSearch('${contextPath}',1)" class="btn btn-primary">
            Accept
        </button>
    </form>
